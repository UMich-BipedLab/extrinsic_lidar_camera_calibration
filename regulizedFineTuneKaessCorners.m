function X = regulizedFineTuneKaessCorners(X, Y, edges_points, P, correspondance_per_pose, display)
    ...
    for i = 1 : num_scan
        ...
        f = fcn2optimexpr(@regulizedCostOfFineTuneKaessCorners, theta_x, theta_y, theta_z, T, ...
                         X(:,scan_num:scan_num+correspondance_per_pose-1), Y(:,scan_num:scan_num+correspondance_per_pose-1), edges_points(i), P);
